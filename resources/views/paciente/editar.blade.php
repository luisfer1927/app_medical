...
<form name="frmRegistrar" method="POST" action="{{ url('/paciente/actualizar',$paciente->id) }}" class="row g-3 needs-validation">
    @csrf
    @method('PUT')
  <div class="col-md-4">
    <label for="documento" class="form-label">Documento</label>
    <input type="text" id="documento" class="form-control" id="documento" name="documento" value="{{ $paciente->documento }}" required>
  ...
  <div class="col-md-4">
    ...
    <input type="text" class="form-control" id="genero" name="genero" value="{{ $paciente->genero }}" required> 
  </div>
  ...
  <div class="col-md-4">
    ...
    <input type="text" class="form-control" id="estadoCivil" name="estadoCivil" value="{{ $paciente->estadoCivil }}" required> 
  </div>
  ...
  <div class="col-12 d-flex justify-content-center">
    <button class="btn btn-primary m-2" type="submit">Actualizar paciente</button>
  </div>
</form>
